...
def create_project(
    ...
    return project.create_project(
        title, featured_image, description, demo_link, source_link, db, current_user
    )
...
def update_project(
    ...
    return project.update_project(
        id, title, featured_image, description, demo_link, source_link, db
    )
